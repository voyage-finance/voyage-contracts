...
interface JuniorDepositTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class JuniorDepositToken extends BaseContract {
  ...
  interface: JuniorDepositTokenInterface;
