...
interface SeniorDepositTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class SeniorDepositToken extends BaseContract {
  ...
  interface: SeniorDepositTokenInterface;
