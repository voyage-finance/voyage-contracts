...
interface IVoyageIncentivesControllerInterface extends ethers.utils.Interface {
  functions: {
...
export class IVoyageIncentivesController extends BaseContract {
  ...
  interface: IVoyageIncentivesControllerInterface;
