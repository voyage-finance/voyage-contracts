...
contract CrabadaExternalAdapter is IExternalAdapter {
        ...
        )
    {
        ...
        if (validateMarketplaceFunc(param.target, param.selector, payload)) {
            ...
            (bool success, bytes memory returnedData) = marketPlace.staticcall(
            ...
            beforeTarget[0] = VaultDataFacet(param.vault).creditEscrow(
                erc20Addr
            );
